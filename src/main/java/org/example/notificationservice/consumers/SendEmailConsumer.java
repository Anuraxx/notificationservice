...
import org.example.notificationservice.dtos.SendEmailMessageDto;
import org.example.notificationservice.utils.EmailUtils;
    ...
    public void handleSendEmail(String message) throws JsonProcessingException {
        ...
        Authenticator auth = new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("omavihso@gmail.com", "");
            }
        };
